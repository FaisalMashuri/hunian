  ...
  return (
    <div className="rounded-[14px] border border-zinc-200 bg-white p-4 shadow-sm">
      <div className="mb-3 flex flex-wrap items-center justify-between gap-2">
        ...
        <span className="text-[12px] text-zinc-500">Semua kandidat · skala Rp 0 – {rpFull(scaleMax)}</span>
      </div>
      ...
      <div className="relative h-12">
        {clusters.length === 0 ? (
          <p className="pt-3 text-[11px] text-zinc-400">Belum ada kandidat untuk dipetakan.</p>
        ) : (
          clusters.map((cl, ci) => {
